<template>
	<div class="collection">
		<mhead theme="收藏"></mhead>

		<div class="pt56" v-if="success">
			<mu-list v-if="collect.length>0">
					<router-link v-for="item in collect" :to="{name:'topic',params:{id:item.id}}">
		...
		<div v-if="!success" class="error"><img src="../assets/imgs/loading.gif" alt=""></div>
	</div>
</template>
